...
// HttpServlet 처리담당자 -> 자동으로 doGet, doPost 호출
	...
	protected void doProcess(HttpServletRequest request, HttpServletResponse response)
		...
		if (sPath.equals("/main.camp")) {
			...
			dispatcher = request.getRequestDispatcher("camppymain/mainpage/mainpage.jsp");
...
// List<CampRegDTO> campregList = getCampRegList(); 메서드 호출
			...
			dispatcher = request.getRequestDispatcher("camppymain/searchpage/camppage.jsp");
			dispatcher.forward(request, response);
		} //
		...
		if (sPath.equals("/listSearch.camp")) {
			...
			if (sido.equals("시/도 선택") && keywordsearch.equals("")) {
				...
				dispatcher = request.getRequestDispatcher("camppymain/searchpage/searchpage.jsp");
				dispatcher.forward(request, response);
			} //
		}
