	...
	<form action="insertPro.me" id="join" method="post">
		<div class="slide-16-9-1">
			...
			<div class="slide-16-9-1__passcheck-box">
				<input type="password" id="memberSingCh" class="check" name="check"
					placeholder="비밀번호 확인">
			</div>
			<div class="slide-16-9-1__nickname-box">
				<input type="text" id="nick" class="nick" name="nick"
					placeholder="닉네임">
			...
			<img class="slide-16-9-1__camppy-2"
				src="member/join/images/camppy-2.png" />

			<div class="slide-16-9-1__terms-box">
				<div class="slide-16-9-1__">
					[필수] 약관 전체 동의 <input type="checkbox" id="large-checkbox"
						name="large-checkbox"
