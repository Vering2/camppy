...
<body>
	...
	<div class="section-login">
		<div class="section-login__login">
			<button type="button"
				onclick="openCenteredPopup('insert.me', 'ReviewPopup', 780, 920)"
				class="section-login__">회원가입</button>
			<button type="button"
				onclick="openCenteredPopup('login.me', 'ReviewPopup', 700, 850)"
				class="section-login__1">로그인</button>
		</div>
	</div>
	<%
	} else {
	...
	<div class="logout">
		...
		if (id.equals("admin")) {
		%>
		<button type="button" onclick="location.href='campreg.campreg'"
			class="logout__button1">캠핑장 등록</button>
		<button type="button" onclick="location.href='admin_reserve.re'"
			class="logout__button2">예약 관리</button>
		<%
		}
		%>

		<div class="logout___000"><%=nickname%>님
		</div>
		<!-- <img
  ...
  /> -->
		...
		<button type="button" onclick="location.href='logout.me'"
			class="logout__button">로그아웃</button>
	...
	<div class="section-header">
		<button type="button" onclick="location.href='main.camp'"
			class="section-header__main-logo>">
	...
	<div class="section-navi">
		<div class="section-navi__navi-list">
			<div class="section-navi__navi-list-1">
				<button type="button" onclick="location.href='list.camp'"
					class="section-navi__link">캠핑장</button>
			</div>
			<div class="section-navi__navi-list-2">
				<button type="button"
					onclick="location.href='commuContentsList.commu'"
					class="section-navi__link">커뮤니티</button>
			</div>
			<div class="section-navi__navi-list-3">
				<button type="button" onclick="location.href='list.qu'"
					class="section-navi__link">문의하기</button>
			</div>
      ...
      <button type="button" onclick="location.href='campreg.campreg'" class="section-navi__link">예약조회</button>
			...
			<div class="section-navi__navi-list-5">
				<button type="button" onclick="location.href='likeList.my'"
					class="section-navi__link">마이페이지</button>
			</div>
		</div>
	</div>
	<script type="text/javascript">
