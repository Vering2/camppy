	...
	<div class="campInfo">
		...
		<div class="infoSectionBody">
			...
			<div class="campCenterImg">
				<img class="campCenterImg1" src="campimg/<%=detailDTO.getPic3()%>" />
				<img class="campCenterImg2" src="campimg/<%=detailDTO.getPic4()%>" />
				<img class="campCenterImg3" src="campimg/<%=detailDTO.getPic5()%>" />
			</div>
			...
			<div class="campInfoFacilities">
				...
				<!-- 추신 -->
				<div class="infoSpan">
					<span class="infoSpan1">  * 캠피에 등록된 정보는 현장 상황과 다소 다를 수 있으니 </span>
					<span class="infoSpan2"> 반려동물 동반 여부, 부가 시설물, 추가 차 </span> <span
						class="infoSpan3"> 등 원활한 캠핑을 위해 꼭 필요한 사항은 해당 캠핑장에 미리 확인하시기
						바랍니다.</span>
				</div>
			</div>
		</div>
