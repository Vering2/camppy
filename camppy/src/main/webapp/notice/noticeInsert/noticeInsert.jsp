		...
		<div class="noticeInsertSectionBody">
			...
			<form action="writePro.no" method="post">
				<div class="noticeInsertBodyContents">
					...
					<tr>
						<td><input type="text" name="created_by" readonly="readonly"
							value="<%=id%>" class="name"></td>
					</tr>
					...
					<!--            제목을 입력해 주세요 -->
					<input type="text" maxlength="30" class="noticeInsert2"
						name="title">
				...
				<div class="noticeInsertButton">
					...
					<input type="button" class="noticeInsertLeaveButton" value="나가기"
						onclick="location.href='list.no'"> <input type="submit"
						class="noticeInsertRegisterButton" value="등록">
				</div>
			</form>
