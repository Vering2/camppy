		...
		<div class="noticeContentsSectionBody">
			<div class="noticeContentsQuestionContents">
				...
				<div class="noticeContentsName">
					<div class="noticeContentsE"><%=noticeDTO.getCreated_by()%>
						&nbsp;
					</div>
				</div>

				<div class="noticeContentsDateNbutton">
					<div class="noticeContents2023"><%=format.format(noticeDTO.getCreate_date())%></div>
				</div>
				...
				<div class="ContentsNbutton">
					...
					<input type="button" class="noticeContentsH" value="수정"
						onclick="location.href='update.no?notice_id=<%=noticeDTO.getNotice_id()%>'">
					<input type="button" class="noticeContentsI" value="삭제"
						onclick="location.href='delete.no?notice_id=<%=noticeDTO.getNotice_id()%>'">

					<input type="button" class="noticeContents22" value="목록"
