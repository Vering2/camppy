		...
		<div class="mainpage__section-total">
			<div class="mainpage__section-search">
				<div class="mainpage__bg">
					<img class="mainpage___73222-f-48-f-4887-1"
				...
				<div class="mainpage__search">
					<div class="mainpage__div-search-title">
						<div class="mainpage__div-search-text">
							<div class="mainpage___3657">
								캠피는 등록된
								<%=campregDAO.getCampRegCount()%>개의 캠핑장 정보를 볼 수 있습니다.
							</div>
					...
					<div class="mainpage__div-search-box">
						<form action="listSearch.camp" method="post">
							<div class="mainpage__div-searchbox-form">
								<div class="mainpage__div-form-1-2">
									...
									</select> <select name="gungu" class="mainpage__options-2">
										<!-- <option class="mainpage__3" >전체/시/군</option> -->
									</select>
								</div>
								<div class="mainpage__div-form-1-3">
									<input type="text" name="keywordsearch" placeholder="키워드 검색"
										class="mainpage__options">
									<button type="submit" class="mainpage__button">검색</button>
									<!-- 검색 버튼 -->
								</div>
							</div>
						</form>
						...
						<form action="DetailList.re" method="post"
							class="mainpage__div-searchbox-form1">
							<input type="text" name="res_id" placeholder="예약 번호 입력"
								class="mainpage__options1">
							<button type="submit" class="mainpage__button1">예약 조회</button>
							<!-- 검색 버튼 -->
			...
			<div class="mainpage__section-notice">
				<div class="mainpage__notice-left">
					<div class="mainpage__div-notice-head">
						...
						<img class="mainpage__icon-speak"
							src="camppymain/mainpage/icon-speak.png" />
					</div>
				</div>
				<div class="mainpage__notice-center">
					<div class="mainpage__notice-contents">
						<div class="mainpage__item-link">
							...
							%>
							<tr>
								<td class="mainpage__6"><a
									href="content.no?notice_id=<%=noticeDTO.getNotice_id()%>">
										<%=noticeDTO.getTitle()%></a></td>
								<td class="mainpage__notice-date-link"><%=format.format(noticeDTO.getCreate_date())%></td>
							</tr>
							<%
							}
							%>
				...
				<div class="mainpage__notice-right">
					<div class="mainpage__notice-etc">
						...
						<img class="mainpage__free-icon-zoom-in-9546602-1"
							src="camppymain/mainpage/free-icon-zoom-in-9546602-1.png"
							onclick="location.href='list.no'" />
					</div>
				</div>
			</div>
			<div class="mainpage__section-category">
				...
				<div class="mainpage__category-icon">
					...
					<button type="button"
						onclick="location.href='detail.de?campId=<%=campregDTO1.getCampid()%>'">

						<img class="mainpage__icon-1"
							src="campimg/<%=campregDTO1.getCampimg()%>" />
					</button>
					<button type="button"
						onclick="location.href='detail.de?campId=<%=campregDTO2.getCampid()%>'">
						<img class="mainpage__icon-2"
							src="campimg/<%=campregDTO2.getCampimg()%>" />
					</button>
					<button type="button"
						onclick="location.href='detail.de?campId=<%=campregDTO3.getCampid()%>'">
						<img class="mainpage__icon-3"
							src="campimg/<%=campregDTO3.getCampimg()%>" />
					</button>
					<button type="button"
						onclick="location.href='detail.de?campId=<%=campregDTO4.getCampid()%>'">
						<img class="mainpage__icon-4"
			...
			<div class="mainpage__section-best">
				<div class="mainpage__best">
                  ...
                  <%=camprankDTO1.getShortintro()%>
							...
							<button type="button"
								onclick="location.href='detail.de?campId=<%=camprankDTO1.getCampid()%>'">
								<img class="mainpage__best-num-1-img"
                  ...
                  <%=camprankDTO2.getShortintro()%>
							...
							<button type="button"
								onclick="location.href='detail.de?campId=<%=camprankDTO2.getCampid()%>'">
								<img class="mainpage__best-num-2-img"
                  ...
                  <%=camprankDTO3.getShortintro()%>
							...
							<button type="button"
								onclick="location.href='detail.de?campId=<%=camprankDTO3.getCampid()%>'">
								<img class="mainpage__best-num-3-img"
                  ...
                  <%=camprankDTO4.getShortintro()%>
							...
							<button type="button"
								onclick="location.href='detail.de?campId=<%=camprankDTO4.getCampid()%>'">
								<img class="mainpage__best-num-4-img"
                  ...
                  <%=camprankDTO5.getShortintro()%>
							...
							<button type="button"
								onclick="location.href='detail.de?campId=<%=camprankDTO5.getCampid()%>'">
								<img class="mainpage__best-num-5-img"
